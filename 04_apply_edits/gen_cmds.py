...
class GenCmds(PBPTGenQProcessToolCmds):
    def gen_command_info(self, **kwargs):
        ...
        for tile in tiles:
            ...
            #)
            out_img = os.path.join(kwargs["out_dir"], f"gmw_{tile}_hab_{kwargs['gmw_hab_new_version']}.tif")
    ...
    def run_gen_commands(self):
        ...
        self.gen_command_info(
            ...
            old_hab_dir="/bigdata/petebunting/GlobalMangroveWatch/gmw_hab_extent/data/gmw_hab_v23_tiles",
            gmw_hab_prev_version="v23",
            gmw_hab_edit_version="v23_to_v24",
            gmw_hab_new_version="v24",
            gmw_tiles_vec_file="../01_gmw_tiles/gmw_degree_tiles.geojson",
            gmw_tile_vec_lyr="gmw_degree_tiles",
            #out_dir="gmw_hab_tiles",
            out_dir="/bigdata/petebunting/GlobalMangroveWatch/gmw_hab_extent/data/gmw_hab_v24_tiles",
        )
