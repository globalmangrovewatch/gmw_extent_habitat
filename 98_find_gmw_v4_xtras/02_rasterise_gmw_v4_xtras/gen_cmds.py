...
class GenCmds(PBPTGenQProcessToolCmds):
    def gen_command_info(self, **kwargs):
        ...
        for base_img in base_tiles:
            ...
            out_img = os.path.join(kwargs["out_dir"], f"{basename}_gmw_v4_edits.kea")
    ...
    def run_gen_commands(self):
        ...
        self.gen_command_info(
            ...
            gmw_vec_file="gmw_v4_edits.gpkg",
            gmw_vec_lyr="gmw_v4_edits",
            out_dir="/bigdata/petebunting/GlobalMangroveWatch/gmw_hab_extent/data/gmw_v4019_edits_tiles",
        )
