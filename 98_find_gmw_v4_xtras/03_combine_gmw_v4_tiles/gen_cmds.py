...
class GenCmds(PBPTGenQProcessToolCmds):
    def gen_command_info(self, **kwargs):
        ...
        for base_img in base_tiles:
            ...
            if not os.path.exists(out_img):
                ...
                c_dict["gmw_v4_edits_img"] = gmw_v4_edits_img
    ...
    def run_gen_commands(self):
        ...
        self.gen_command_info(
            ...
            gmw_v4_dir="/bigdata/petebunting/GlobalMangroveWatch/gmw_hab_extent/data/gmw_v4019_tiles",
            gmw_v4_edits="/bigdata/petebunting/GlobalMangroveWatch/gmw_hab_extent/data/gmw_v4019_edits_tiles",
            out_dir="/bigdata/petebunting/GlobalMangroveWatch/gmw_hab_extent/data/gmw_v4019_fnl_tiles",
        )
